...
competitivecyclist_config = {
    ...
    "selectors": {
        ...
        "img": {'tag': 'img', "attributes": {'class': 'chakra-image css-8atqhb', 'data-id': 'mainImage'}, "get_tag" : "src"},
...
triathletesports_config = {
        ...
        "selectors": {
            ...
            "details": {'tag': 'div', 'attributes' : {'id': 'accordion--description'}},
            "img": {'tag': 'a', "attributes": {'target':"_blank"}, "get_tag" : "href"},
